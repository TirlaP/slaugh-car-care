      ...
      >
         ...
         <div className="flex h-full w-full flex-col items-center justify-center font-header text-default">
            ...
            >
               ...
               <br />
               <span className="text-primary">EXPERI</span>
               <span className="text-tertiary">ENCED</span>
            </MotionH1>
            <div className="flex items-center gap-x-2 md:gap-x-4">
               ...
               >
                  <span className="text-end">HONEST AUTO</span>
                  <span className="text-end">REPAIR EXPERTS</span>
               </MotionP>
               <MotionH1
                  variants={{
                     offscreen: { opacity: 0, y: 100 },
